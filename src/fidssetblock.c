...
int push_s(char *s)
{
    ...
    if (len_b + len_s < CMDL_C)
    {
        for (i = len_b + 1; i; i--)
            cbuf[i + len_s - 1] =
                cbuf[i - 1]; /*lint !e676 Possibly negative subscript (-1) in
                                operator '[' */

        for (i = 0; i < len_s; i++)
            cbuf[i] = s[i]; /*lint !e676 Possibly negative subscript (-1) in
                               operator '[' */
    ...
    switch (gkb[1])
    {
        ...
        case '[': /* ESC [ ... */
            ...
            if (gkb[2] >= '1' && gkb[2] <= '9')
            {
                ...
                if (gkb[3] >= '0' && gkb[3] <= '9')
                {
                    ...
                    switch ((gkb[2] - '0') * 10 + (gkb[3] - '0'))
                    {
                        case 11:
                            return (PFKY('1')); /* PC F1       */
                        case 17:
                            return (PFKY('6')); /* vt220 F6    */
                        case 12:
                            return (PFKY('2')); /* PC P2       */
                        case 18:
                            return (PFKY('7')); /* vt220 F7    */
                        case 13:
                            return (PFKY('3')); /* PC F3       */
                        case 19:
                            return (PFKY('8')); /* vt220 F8    */
                        case 14:
                            return (PFKY('4')); /* PC F4       */
                        case 20:
                            return (PFKY('9')); /* vt220 F9    */
                        case 15:
                            return (PFKY('5')); /* PC F5       */
                        case 21:
                            return (PFKY('2')); /* vt220 F10   */
                        case 23:
                            return (ESC); /* vt220 F11   */
                        case 24:
                            return (CTRL('H')); /* vt220 F12   */
                        case 25:
                            return (PFKY('3')); /* vt220 F13   */
                        case 26:
                            return (PFKY('4')); /* vt220 F14   */
                        case 28:
                            return (ESC1('h')); /* vt220 Help  */
                        case 29:
                            return (ESC1('X')); /* vt220 Do    */
                        case 31:
                            return (PFKY('5')); /* vt220 F17   */
                        case 32:
                            return (PFKY('6')); /* vt220 F18   */
                        case 33:
                            return (PFKY('7')); /* vt220 F19   */
                        case 34:
                            return (PFKY('8')); /* vt220 F20   */
                    }
                    break;
                }
                ...
                {
                    case '1':
                        return (ESC1('<')); /* vt220 Find   */
                    case '2':
                        return (ESC1('#')); /* vt220 Insert */
                    case '3':
                        return (ESC1('R')); /* vt220 Remove */
                    case '4':
                        return (ESC1('@')); /* vt220 Select */
                    case '5':
                        return (ESC1('P')); /* vt220 Prev   */
                    case '6':
                        return (ESC1('N')); /* vt220 Next   */
                }
                break;
            }
            ...
            switch (gkb[2])
            {
                ...
                gkb[3] -
                    32 : 0 left button down 1 middle button down 2 right button
                                                            down 3 button up

                            gkb[4] -
                    32 : x - position(column) gkb[5] - 32 : y -
                                                            position(row)
                ...
                case 'U':
                    return (PFKY('9'));
                case 'H':
                    return (ESC1('<')); /* ANSI - Home */
                case 'F':
                    return (ESC1('>')); /* ANSI - End  */
                case 'I':
                    return (ESC1('P')); /* ANSI - PgUp */
                case 'G':
                    return (ESC1('N')); /* ANSI - PgDn */
                case 'L':
                    return (ESC1('#')); /* ANSI - Insert */
/*		    default :	return( (int)gkb[2] + ES2 );	*/
#endif

#if defined QNX4 || defined QNX6
                case '@':
                    return (ESC1('#')); /* qnx2 ansi - Insert -> Toggle Insert */
                case 'P':
                    return (ESC1('R')); /* qnx2 ansi - Delete -> Remove */
                case 'U':
                    return (ESC1('N')); /* qnx2 ansi - PgDown -> Next Cmd */
                case 'V':
                    return (ESC1('P')); /* qnx2 ansi - PgUp   -> Prev Cmd */
                case 'H':
                    return (ESC1('<')); /* qnx2 ansi - Home   -> Jmp BOL */
                case 'Y':
                    return (ESC1('>')); /* qnx2 ansi - End    -> Jmp EOL */
#endif
            }
            break;
...
#if defined QNX4 || defined QNX6
                case 'P':
                    return (PFKY('1')); /* qnx2 ansi - F1  */
                case 'Q':
                    return (PFKY('2')); /* qnx2 ansi - F2  */
                case 'R':
                    return (PFKY('3')); /* qnx2 ansi - F3  */
                case 'S':
                    return (PFKY('4')); /* qnx2 ansi - F4  */
                case 'T':
                    return (PFKY('5')); /* qnx2 ansi - F5  */
                case 'U':
                    return (PFKY('6')); /* qnx2 ansi - F6  */
                case 'V':
                    return (PFKY('7')); /* qnx2 ansi - F7  */
                case 'W':
                    return (PFKY('8')); /* qnx2 ansi - F8  */
                case 'X':
                    return (PFKY('9')); /* qnx2 ansi - F9  */
                case 'Y':
                    return (PFKY('0')); /* qnx2 ansi - F10 */

                case 'p':
                    return (PFKY('a')); /* qnx2 ansi - F1  */
                case 'q':
                    return (PFKY('b')); /* qnx2 ansi - F2  */
                case 'r':
                    return (PFKY('c')); /* qnx2 ansi - F3  */
                case 's':
                    return (PFKY('d')); /* qnx2 ansi - F4  */
                case 't':
                    return (PFKY('e')); /* qnx2 ansi - F5  */
                case 'u':
                    return (PFKY('f')); /* qnx2 ansi - F6  */
                case 'v':
                    return (PFKY('g')); /* qnx2 ansi - F7  */
                case 'w':
                    return (PFKY('h')); /* qnx2 ansi - F8  */
                case 'x':
                    return (PFKY('i')); /* qnx2 ansi - F9  */
#else
                case 'M':
                    return (ESC1('J')); /* Retrieve cmd */
                case 'P':
                    return (PFKY('1')); /* PF's vt100   */
                case 'Q':
                    return (PFKY('2'));
                case 'R':
                    return (PFKY('3'));
